...
* DONE Tests for unixcw version 3.6.1
...
** DONE FreeBSD 13.2-RELEASE-p4 (Celeron, x86_64)
...
Due to limited power of this machine and due to limited count of features
supported on this machine, I have tested only the following set of options:
...
*Actual result*
Pass. All files were played correctly.
...
The parameters of sound are changing as expected. No problems with played
tones were observed.
...
*Actual result*
Pass. No errors were observed

***** SKIPPED ALSA sound system
...
*Actual result*
Skipped. ALSA is not available on this machine.

***** DONE OSS sound system
...
*Actual result*
Sounds played correctly. No errors observed.

***** SKIPPED PulseAudio sound system

./src/cw/cw -s p

*Actual result*
Skipped. PulseAudio is not available on this machine.
...
*Actual result*
Pass. Didn't obsere any problems with played sound.
...
Pass. All grops produce expected sound, with words made from expected
characters.
...
*Actual results*
Pass. The entered words are played correctly.
...
Pass. Properties of played Morse code change according to the set parameters.
...
*Actual results*
Pass. The keys control practice time as expected. The practice ends when
expected.
...
*Actual results*
Pass. cwcp is exited correctly. No errors or artifacts are present.

*** SKIPPED xcwcp tests

Skipped. xcwcp is not compiled on this platform.
...
*Actual results*
Pass. All outputs are as expected.
...
*Actual results*
Pass. Visual inspection found no errors.
...
*Actual results*
Skipped. xcwcp is not being compiled on this platform.
