...
* STARTED Come up with new version numbers
...
** STARTED Update the unixcw package number throughout unixcw package
...
** STARTED Update the libcw version number throughout unixcw package
